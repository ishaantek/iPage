...
const dict = {
	...
	'if you love iPage': {
		fr: 'si vous aimez iPage',
		sv: 'om du älskar iPage',
		nl: 'als je van iPage houdt',
		pl: 'jeśli kochasz iPage',
		pt_BR: 'se você ama o iPage',
		ru: 'если вы любите iPage',
		zh_CN: '来支持 iPage',
		sk: 'Ak miluješ iPagea',
		de: 'wenn du iPage liebst',
		it: 'se ami iPage',
		es: 'si amas iPage',
	},
	'Love using iPage? Consider giving us a review or donating, that would help a lot! 😇': {
		fr: 'Vous adorez utiliser iPage ? Pensez à nous noter ou faire un don, ça serait super ! 😇',
		sv: 'Älskar du att använda iPage? Överväg att ge oss en recension eller donera, det skulle hjälpa mycket! 😇',
		nl: 'Ben je dol op het gebruik van iPage? Overweeg om ons een recensie te geven of te doneren, dat zou veel helpen! 😇',
		pl: 'Uwielbiasz korzystać z iPage? Zastanów się nad wystawieniem nam recenzji lub darowizny, co bardzo by pomogło! 😇',
		pt_BR: 'Gosta de usar o iPage? Considere nos avaliar, isso ajudaria muito! 😇',
		ru: 'Любите использовать iPage? Подумайте о том, чтобы оставить нам отзыв или сделать пожертвование, это очень поможет! 😇',
		zh_CN: '喜欢使用 iPage？ 考虑给我们一个评论或捐赠，这会很有帮助！ 😇',
		sk: 'Máte radi používanie iPageu? Skúste nám dať recenziu alebo darovať, to by veľmi pomohlo! 😇',
		de: 'Lieben Sie es, iPage zu benutzen? Erwägen Sie, uns eine Bewertung zu geben oder zu spenden, das würde viel helfen! 😇',
		it: 'Ti piace usare iPage? Considera di darci una recensione o di fare una donazione, sarebbe di grande aiuto! ?',
		es: '¿Te encanta usar iPage? Considere darnos una reseña o hacer una donación, ¡eso ayudaría mucho! 😇',
	},
	Review: {
		fr: 'Noter',
		sv: 'Recension',
	...
	"These are iPage's bookmarks. ": {
		fr: 'Ce sont les favoris de iPage. ',
		sv: 'Det här är iPages bokmärken. ',
		nl: 'Dit zijn de bladwijzers van iPage. ',
		pl: 'To są zakładki iPage. ',
		pt_BR: 'Esses são os favoritos do iPage. ',
		ru: 'Это закладки iPage. ',
		zh_CN: '这些是 iPage 的书签。',
		sk: 'Toto sú záložky iPageu. ',
		de: 'Dies sind iPages Lesezeichen. ',
		it: 'Questi sono i segnalibri di iPage. ',
		es: 'Estos son los marcadores de iPage. ',
	},
	...
	'Type the collection id from its URL, add more by separating them with a comma.': {
		...
		de: 'Geben Sie die Sammlung ID aus ihrer URL ein. Fügen Sie weitere hinzu, indem Sie sie durch ein Komma trennen.',
